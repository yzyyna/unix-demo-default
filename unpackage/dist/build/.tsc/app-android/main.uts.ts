...
export class UniAppConfig extends io.dcloud.uniapp.appframe.AppConfig {
    override name: string = "unix-demo-default"
    override appid: string = "__UNI__C9725AD"
...
import GenPagesIndexPage2Class from './pages/index/page2.uvue'
import GenPagesIndexPage3nativeClass from './pages/index/page3native.uvue'
...
__uniRoutes.push({ path: "pages/index/page2", component: GenPagesIndexPage2Class, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationBarTitleText","Page2"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/index/page3native", component: GenPagesIndexPage3nativeClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationBarTitleText","Page3 native"]]) } as UniPageRoute)
}
