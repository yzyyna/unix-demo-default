(function(vue) {
  ...
  function initRuntimeSocketService() {
    const hosts = "127.0.0.1,192.168.110.88,10.211.55.2,10.37.129.2,169.254.172.78";
    const port = "8090";
    const id = "app-ios_ntu2jP";
    let socketTask = null;
  ...
  const name$1 = "fpssModbusTcp";
  const moduleName$1 = "fpss-modbus-tcp";
  const moduleType$1 = "";
  const errMsg$1 = "uts插件[fpss-modbus-tcp]编译失败，无法使用";
  ...
  const _sfc_main$5 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      const connectClient = (flag = null) => {
        if (flag) {
          uni.__log__("log", "at pages/index/page-modbus.uvue:17", "uvue:开始连接");
          connect();
        } else {
          disConnect();
          msg.value = "断开";
      ...
      const writeRegister = () => {
        msg.value = "写入寄存器测试";
        writeHoldingRegisters(0, [100, 200, 300], (success = null, error = null) => {
          if (success) {
            msg.value = "写入寄存器成功";
          } else {
  ...
  const PagesIndexPageModbus = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "/Users/fortrust/Documents/HBuilderProjects/unix-demo-default/pages/index/page-modbus.uvue"]]);
  ...
  const name = "uniMemoryInfo";
  const moduleName = "uni-MemoryInfo";
  const moduleType = "";
  const errMsg = "";
  const is_uni_modules = true;
  const pkg = /* @__PURE__ */ initUTSPackageName(name, is_uni_modules);
  const cls = /* @__PURE__ */ initUTSIndexClassName(name, is_uni_modules);
  const getMemoryInfo = /* @__PURE__ */ initUTSProxyFunction(false, { moduleName, moduleType, errMsg, main: true, package: pkg, class: cls, name: "getMemoryInfoByJs", keepAlive: false, params: [], return: "" });
  const onMemoryInfoChange = /* @__PURE__ */ initUTSProxyFunction(false, { moduleName, moduleType, errMsg, main: true, package: pkg, class: cls, name: "onMemoryInfoChangeByJs", keepAlive: false, params: [{ "name": "callback", "type": "UTSCallback" }], return: "" });
  const offMemoryInfoChange = /* @__PURE__ */ initUTSProxyFunction(false, { moduleName, moduleType, errMsg, main: true, package: pkg, class: cls, name: "offMemoryInfoChangeByJs", keepAlive: false, params: [], return: "" });
