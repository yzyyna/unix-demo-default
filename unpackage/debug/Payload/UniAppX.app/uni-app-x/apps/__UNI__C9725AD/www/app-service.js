        ...
        return vue.openBlock(), vue.createElementBlock("view", null, [
          vue.createElementVNode("button", new UTSJSONObject({
            onClick: _cache[0] || (_cache[0] = ($event = null) => {
              return _ctx.connectClient(true);
            })
          }), "连接Modbus服务器"),
          vue.createElementVNode("button", new UTSJSONObject({
            onClick: _cache[1] || (_cache[1] = ($event = null) => {
              return _ctx.connectClient(false);
            })
          }), "断开Modbus服务器"),
          vue.createElementVNode("button", new UTSJSONObject({
            onClick: _cache[2] || (_cache[2] = (...args) => {
              return _ctx.clickTestApi && _ctx.clickTestApi(...args);
            })
          }), "测试Api"),
          vue.createElementVNode("view", null, vue.toDisplayString(_ctx.msg), 1)
        ]);
      };
    }
  });
