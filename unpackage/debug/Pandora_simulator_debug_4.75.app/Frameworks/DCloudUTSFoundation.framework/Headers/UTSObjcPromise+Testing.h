 ...
 */
FOUNDATION_EXTERN BOOL UTSObjcWaitForPromisesWithTimeout(NSTimeInterval timeout) NS_REFINED_FOR_SWIFT;

@interface UTSObjcPromise<Value>(TestingAdditions)
 ...
 */
@property(nonatomic, readonly, nullable) id error NS_REFINED_FOR_SWIFT;
