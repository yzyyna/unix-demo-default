...
open class MyApiOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("MyApiOptions", "uni_modules/my-test-plugin/utssdk/interface.uts", 8, 13)
    }
}
open class MyApiResult (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("MyApiResult", "uni_modules/my-test-plugin/utssdk/interface.uts", 19, 13)
    }
}
...
open class MyApiFailImpl : UniError, MyApiFail, IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("MyApiFailImpl", "uni_modules/my-test-plugin/utssdk/unierror.uts", 24, 14)
    }
